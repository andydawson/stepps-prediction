...
#           suff_fit = '12taxa_699cells_120knots_0to2000ypb_KW_KGAMMA_PL_umw_3by_v2',
...
PL = list(suff_dat  = '12taxa_699cells_120knots_0to2000ypb_PL_umw_3by_v0.3_bacon',
          suff_fit  = '12taxa_699cells_120knots_0to2000ypb_PL_umw_3by_v3_bacon',
          suff_figs = 'PL')
