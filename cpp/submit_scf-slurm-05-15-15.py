...
runs = [ ('pred_PL_test_KW_KGAMMA',
          './pred_od_mpp_full_nug_mu0_kw_kgamma_262.exe \
          sample num_warmup=75 num_samples=1000 save_warmup=1\
          data file=../r/dump/12taxa_699cells_120knots_0to2000ypb_COPY_PL_umw_3by_v0.3.dump \
          output file=../output/12taxa_699cells_120knots_0to2000ypb_COPY_PL_umw_3by_v0.3.dump \
          random seed=42'),
         ('pred_G_test_KW_KGAMMA',
          './pred_od_mpp_full_nug_mu0_kw_kgamma_262.exe \
          sample num_warmup=75 num_samples=1000 save_warmup=1\
          data file=../r/dump/12taxa_699cells_120knots_0to2000ypb_COPY_G_umw_3by_v0.3.dump \
          output file=../output/12taxa_699cells_120knots_0to2000ypb_COPY_G_umw_3by_v0.3.dump \
          random seed=42')
]
