...
runs = [ ('pred_kw_kgamma_G',
          ...
          data file=../r/dump/12taxa_699cells_120knots_cal_KW_KGAMMA_G_umw_3by_v0.3.dump \
          output file=../output/12taxa_699cells_120knots_cal_KW_KGAMMA_G_umw_3by.dump \
          random seed=42'),
         ('pred_kw_kgamma_PL',
          './pred_kw_kgamma_no_time_262.exe \
          sample num_warmup=150 num_samples=1000 save_warmup=1\
          data file=../r/dump/12taxa_699cells_120knots_cal_KW_KGAMMA_PL_umw_3by_v0.3.dump \
          output file=../output/12taxa_699cells_120knots_cal_KW_KGAMMA_PL_umw_3by.dump \
          random seed=42'),
         ('pred_G_cal',
         ...
         ('pred_PL_cal',
          './pred_base_no_time_262.exe \
          sample num_warmup=150 num_samples=1000 save_warmup=1\
          data file=../r/dump/12taxa_699cells_120knots_cal_PL_umw_3by_v0.3.dump \
          output file=../output/12taxa_699cells_120knots_cal_PL_umw_3by.dump \
          random seed=42')
]
