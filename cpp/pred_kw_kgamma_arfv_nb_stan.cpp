...
namespace pred_kw_kgamma_arfv_nb_stan_model_namespace {
...
class pred_kw_kgamma_arfv_nb_stan_model : public prob_grad {
private:
    int K;
    int N;
    int T;
    ...
    matrix_d M;
public:
    pred_kw_kgamma_arfv_nb_stan_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        static const char* function__ = "pred_kw_kgamma_arfv_nb_stan_model_namespace::pred_kw_kgamma_arfv_nb_stan_model";
        ...
        validate_non_negative_index("y", "(N_cores * T)", (N_cores * T));
        ...
        validate_non_negative_index("rho", "(K - 1)", (K - 1));
        rho = vector_d((K - 1));
        ...
        gamma = vector_d(K);
        context__.validate_dims("data initialization", "gamma", "vector_d", context__.to_vec(K));
        vals_r__ = context__.vals_r("gamma");
        pos__ = 0;
        size_t gamma_i_vec_lim__ = K;
        for (size_t i_vec__ = 0; i_vec__ < gamma_i_vec_lim__; ++i_vec__) {
            gamma[i_vec__] = vals_r__[pos__++];
        }
        context__.validate_dims("data initialization", "res", "double", context__.to_vec());
        res = double(0);
        ...
        validate_non_negative_index("sum_w_pot", "K", K);
        ...
        validate_non_negative_index("idx_cores", "N_cores", N_cores);
        ...
        validate_non_negative_index("d_knots", "N_knots", N_knots);
        validate_non_negative_index("d_knots", "N_knots", N_knots);
        ...
        validate_non_negative_index("d_inter", "N", N);
        validate_non_negative_index("d_inter", "N_knots", N_knots);
        ...
        validate_non_negative_index("w", "N_cores", N_cores);
        validate_non_negative_index("w", "N", N);
        w = std::vector<matrix_d>(K,matrix_d(N_cores,N));
        ...
        W = int(0);
        validate_non_negative_index("eta2", "(K - 1)", (K - 1));
        eta2 = vector_d((K - 1));
        validate_non_negative_index("zeros", "N_knots", N_knots);
        zeros = vector_d(N_knots);
        validate_non_negative_index("Eye_knots", "N_knots", N_knots);
        validate_non_negative_index("Eye_knots", "N_knots", N_knots);
        Eye_knots = matrix_d(N_knots,N_knots);
        validate_non_negative_index("C_s", "(K - 1)", (K - 1));
        validate_non_negative_index("C_s", "N_knots", N_knots);
        validate_non_negative_index("C_s", "N_knots", N_knots);
        C_s = std::vector<matrix_d>((K - 1),matrix_d(N_knots,N_knots));
        validate_non_negative_index("C_s_L", "(K - 1)", (K - 1));
        validate_non_negative_index("C_s_L", "N_knots", N_knots);
        validate_non_negative_index("C_s_L", "N_knots", N_knots);
        C_s_L = std::vector<matrix_d>((K - 1),matrix_d(N_knots,N_knots));
        validate_non_negative_index("C_s_inv", "(K - 1)", (K - 1));
        validate_non_negative_index("C_s_inv", "N_knots", N_knots);
        validate_non_negative_index("C_s_inv", "N_knots", N_knots);
        ...
        validate_non_negative_index("M", "(N * T)", (N * T));
        validate_non_negative_index("M", "(N * T)", (N * T));
        M = matrix_d((N * T),(N * T));
        ...
        stan::math::fill(Eye_knots,DUMMY_VAR__);
        stan::math::fill(C_s,DUMMY_VAR__);
        stan::math::fill(C_s_L,DUMMY_VAR__);
        stan::math::fill(C_s_inv,DUMMY_VAR__);
        stan::math::fill(c_s,DUMMY_VAR__);
    ...
    ~pred_kw_kgamma_arfv_nb_stan_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        double ksi(0);
        ksi = vals_r__[pos__++];
        try { writer__.scalar_lub_unconstrain(0,5,ksi); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable ksi: ") + e.what()); }
        ...
        try { writer__.vector_lub_unconstrain(0,1,omega); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable omega: ") + e.what()); }
        ...
        try { writer__.vector_lub_unconstrain(0,10,sigma); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable sigma: ") + e.what()); }
        ...
        try { writer__.vector_lub_unconstrain(0,1,lambda); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable lambda: ") + e.what()); }
        ...
        for (int i0__ = 0U; i0__ < W; ++i0__)
            try { writer__.vector_unconstrain(mu_t[i0__]); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable mu_t: ") + e.what()); }
        ...
        for (int i0__ = 0U; i0__ < W; ++i0__)
            try { writer__.vector_unconstrain(alpha_s[i0__]); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable alpha_s: ") + e.what()); }
        ...
        for (int i0__ = 0U; i0__ < (W * (T - 1)); ++i0__)
            try { writer__.vector_unconstrain(alpha_t[i0__]); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable alpha_t: ") + e.what()); }
        ...
        for (int i0__ = 0U; i0__ < W; ++i0__)
            try { writer__.vector_unconstrain(g[i0__]); } catch (const std::exception& e) {  throw std::runtime_error(std::string("Error transforming variable g: ") + e.what()); }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (jacobian__)
            ksi = in__.scalar_lub_constrain(0,5,lp__);
        else
            ksi = in__.scalar_lub_constrain(0,5);

        Eigen::Matrix<T__,Eigen::Dynamic,1>  omega;
        (void) omega;   // dummy to suppress unused var warning
        if (jacobian__)
            omega = in__.vector_lub_constrain(0,1,K,lp__);
        else
            omega = in__.vector_lub_constrain(0,1,K);

        Eigen::Matrix<T__,Eigen::Dynamic,1>  sigma;
        (void) sigma;   // dummy to suppress unused var warning
        if (jacobian__)
            sigma = in__.vector_lub_constrain(0,10,W,lp__);
        else
            sigma = in__.vector_lub_constrain(0,10,W);

        Eigen::Matrix<T__,Eigen::Dynamic,1>  lambda;
        (void) lambda;   // dummy to suppress unused var warning
        if (jacobian__)
            lambda = in__.vector_lub_constrain(0,1,W,lp__);
        else
            lambda = in__.vector_lub_constrain(0,1,W);
        ...
        for (size_t k_0__ = 0; k_0__ < dim_mu_t_0__; ++k_0__) {
            if (jacobian__)
                mu_t.push_back(in__.vector_constrain((T - 1),lp__));
            else
        ...
        Eigen::Matrix<T__,Eigen::Dynamic,1>  omega2(K);
        (void) omega2;   // dummy to suppress unused var warning
        ...
        for (int k = 1; k <= K; ++k) {
            stan::math::assign(get_base1_lhs(omega2,k,"omega2",1), (get_base1(omega,k,"omega",1) * get_base1(omega,k,"omega",1)));
        }

        // validate transformed parameters
        for (int i0__ = 0; i0__ < K; ++i0__) {
            if (stan::math::is_uninitialized(omega2(i0__))) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: omega2" << '[' << i0__ << ']';
        ...
        try { 
            check_greater_or_equal(function__,"omega2",omega2,0);
            check_less_or_equal(function__,"omega2",omega2,1);
        } catch (const std::exception& e) { 
            throw std::domain_error(std::string("Invalid value of omega2: ") + std::string(e.what()));
        };
        // model body
        {
            ...
            for (int k = 1; k <= W; ++k) {
                lp_accum__.add(normal_log<propto__>(get_base1(get_base1(mu_t,k,"mu_t",1),1,"mu_t",2), 0.0, ksi));
            }
            for (int k = 1; k <= W; ++k) {
            ...
            for (int k = 1; k <= W; ++k) {
                ...
                lp_accum__.add(multi_normal_prec_log<propto__>(get_base1(alpha_t,(((k - 1) * (T - 1)) + 1),"alpha_t",1), zeros, multiply(get_base1(eta,k,"eta",1),get_base1(C_s_L,k,"C_s_L",1))));
                for (int t = 2; t <= (T - 1); ++t) {
                    lp_accum__.add(multi_normal_prec_log<propto__>(get_base1(alpha_t,(((k - 1) * (T - 1)) + t),"alpha_t",1), multiply(get_base1(omega,k,"omega",1),get_base1(alpha_t,(((k * (T - 1)) + t) - 1),"alpha_t",1)), multiply((sqrt((1 - get_base1(omega2,k,"omega2",1))) * get_base1(eta,k,"eta",1)),get_base1(C_s_L,k,"C_s_L",1))));
                }
                for (int t = 1; t <= (T - 1); ++t) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    stan::math::assign(qvar, multiply(multiply(q_i,get_base1(Q_s_inv,k,"Q_s_inv",1)),transpose(q_i)));
                    stan::math::assign(get_base1_lhs(get_base1_lhs(mu_g,k,"mu_g",1),(((i - 1) * T) + 1),"mu_g",2), (get_base1(mu,k,"mu",1) + get_base1(get_base1(mu_g,k,"mu_g",1),(((i - 1) * T) + 1),"mu_g",2)));
                    stan::math::assign(get_base1_lhs(sqrtvar,(((i - 1) * T) + 1),"sqrtvar",1), sqrt((get_base1(eta2,k,"eta2",1) - cvar)));
                    for (int t = 2; t <= T; ++t) {
                        stan::math::assign(get_base1_lhs(get_base1_lhs(mu_g,k,"mu_g",1),(((i - 1) * T) + t),"mu_g",2), (((get_base1(mu,k,"mu",1) + get_base1(get_base1(mu_t,k,"mu_t",1),(t - 1),"mu_t",2)) + get_base1(get_base1(mu_g,k,"mu_g",1),(((i - 1) * T) + t),"mu_g",2)) + get_base1(get_base1(qQinv_alpha,(t - 1),"qQinv_alpha",1),i,"qQinv_alpha",2)));
                        stan::math::assign(get_base1_lhs(sqrtvar,(((i - 1) * T) + t),"sqrtvar",1), sqrt((((get_base1(eta2,k,"eta2",1) - cvar) + get_base1(sigma2,k,"sigma2",1)) - (get_base1(sigma2,k,"sigma2",1) * qvar))));
                    }
                }
                for (int i = 1; i <= (N * T); ++i) {
            ...
            for (int k = 1; k <= K; ++k) {
                for (int i = 1; i <= (N * T); ++i) {
                    stan::math::assign(get_base1_lhs(get_base1_lhs(r,i,"r",1),k,"r",2), (exp(get_base1(get_base1(g,k,"g",1),i,"g",2)) / get_base1(sum_exp_g,i,"sum_exp_g",1)));
                }
            }
            {
                ...
                for (int k = 1; k <= K; ++k) {
                    for (int i = 1; i <= N_cores; ++i) {
                        for (int t = 1; t <= T; ++t) {
                            ...
                            stan::math::assign(get_base1_lhs(get_base1_lhs(r_new,(((i - 1) * T) + t),"r_new",1),k,"r_new",2), (get_base1(gamma,k,"gamma",1) * get_base1(get_base1(r,idx_core,"r",1),k,"r",2)));
                            for (int j = 1; j <= N; ++j) {
                                if (as_bool(logical_neq(j,get_base1(idx_cores,i,"idx_cores",1)))) {
                                    stan::math::assign(get_base1_lhs(out_sum,k,"out_sum",1), (get_base1(out_sum,k,"out_sum",1) + (((res * res) * get_base1(get_base1(w,k,"w",1),i,j,"w",2)) * get_base1(get_base1(r,(((j - 1) * T) + t),"r",1),k,"r",2))));
                                }
                            }
                            stan::math::assign(get_base1_lhs(get_base1_lhs(r_new,(((i - 1) * T) + t),"r_new",1),k,"r_new",2), (get_base1(get_base1(r_new,(((i - 1) * T) + t),"r_new",1),k,"r_new",2) + ((get_base1(out_sum,k,"out_sum",1) * (1 - get_base1(gamma,k,"gamma",1))) / get_base1(sum_w_pot,k,"sum_w_pot",1))));
                        }
                    }
                }
                {
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "pred_kw_kgamma_arfv_nb_stan_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double ksi = in__.scalar_lub_constrain(0,5);
        vector_d omega = in__.vector_lub_constrain(0,1,K);
        vector_d sigma = in__.vector_lub_constrain(0,10,W);
        vector_d lambda = in__.vector_lub_constrain(0,1,W);
    ...
    void write_csv(RNG& base_rng__,
        ...
        stan::io::reader<double> in__(params_r__,params_i__);
        stan::io::csv_writer writer__(o__);
        static const char* function__ = "pred_kw_kgamma_arfv_nb_stan_model_namespace::write_csv";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double ksi = in__.scalar_lub_constrain(0,5);
        writer__.write(ksi);
    ...
    static std::string model_name() {
        return "pred_kw_kgamma_arfv_nb_stan_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= K; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "omega2" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
typedef pred_kw_kgamma_arfv_nb_stan_model_namespace::pred_kw_kgamma_arfv_nb_stan_model stan_model;
